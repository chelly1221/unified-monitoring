...
interface UpsAudioConfigProps {
  config: AudioConfig
  onChange: (config: AudioConfig) => void
  compact?: boolean
}

export function UpsAudioConfig({ config, onChange, compact = false }: UpsAudioConfigProps) {
      ...
      <div className="flex items-center gap-2 rounded border px-2 py-1">
        ...
        >
          <div className="flex items-center space-x-1">
            <RadioGroupItem value="none" id="ups-audio-none-c" className="h-3.5 w-3.5" />
            <Label htmlFor="ups-audio-none-c" className="cursor-pointer font-normal text-xs">없음</Label>
          </div>
          <div className="flex items-center space-x-1">
            <RadioGroupItem value="file" id="ups-audio-file-c" className="h-3.5 w-3.5" />
            <Label htmlFor="ups-audio-file-c" className="cursor-pointer font-normal text-xs">파일</Label>
          </div>
        </RadioGroup>
        {config.type === "file" && (
          <>
            <Label
              htmlFor="ups-audio-upload-c"
      ...
      <div className="flex items-center gap-6">
        ...
        >
          <div className="flex items-center space-x-2">
            <RadioGroupItem value="none" id="ups-audio-none" />
            <Label htmlFor="ups-audio-none" className="cursor-pointer font-normal">
              없음
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <RadioGroupItem value="file" id="ups-audio-file" />
            <Label htmlFor="ups-audio-file" className="cursor-pointer font-normal">
              파일
            </Label>
          </div>
        </RadioGroup>
